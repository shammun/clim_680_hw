...
## ⚙️ Installation or Working with the Code
  ...
  For more detailed information about this class project, refer to the following resources:
    ...
    Notebook Descriptions: Each notebook contains details on what to do and how to do. [Notebook1](https://github.com/shammun/clim_680_hw/blob/main/HW1_New.ipynb), [Notebook2](https://github.com/shammun/clim_680_hw/blob/main/HW2_New.ipynb), [Notebook3](https://github.com/shammun/clim_680_hw/blob/main/HW3_New.ipynb)
